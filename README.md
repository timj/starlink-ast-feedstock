...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/starlink-ast-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/starlink-ast-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add starlink-ast
# for installing globally
pixi global install starlink-ast
```
...
It is possible to list all of the versions of `starlink-ast` available on your platform:
...
```
pixi search starlink-ast --channel conda-forge
```
